...
namespace ChatApp.Persistence.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
            ...
            where T : class
        {
            ...
            {
                { } user when user == typeof(Domain.Users.User) => UserRepository as IRepository<T>,
                { } friend when friend == typeof(Domain.Friends.Friend) => FriendRepository as IRepository<T>,
